...
const {register , logIn , edit ,getUsers,getById,Remove ,payment,plan,destroy,devices,removeDevice,watchMovies,DeletFav,logOut,FavMovies} = require('../Controllers/AuthController')
...
router.put('/watch',authorizeUser,watchMovies)
