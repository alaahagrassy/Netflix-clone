...
const {register , logIn , edit ,getUsers,getById,Remove ,payment,plan,getuser,editForAdmin,destroy,devices,watchedMovies,removeDevice,DeletFav,logOut,FavMovies} = require('../Controllers/AuthController')
